...
> {
     ...
     */
    public get stateData$(): Observable<TStateData | FSMInitStateData> {
    ...
    protected get currentState$(): Observable<CurrentStateInfo<TState, TStateData, TCanLeaveToStatesMap>> {
        return this._stateData$.asObservable().pipe(
            ...
            map((stateTransition: StateTransition<TState, TStateData>) => {
                const stateData: TStateData | FSMInitStateData = stateTransition.stateData;
     ...
     */
    private isTStateData(data: TStateData | FSMInitStateData): data is TStateData {
    ...
    private executeOnEnterHookCallback(
        ...
        nextState: TState,
        previousStateData: TStateData | FSMInitStateData,
        nextStateData: TStateData,
